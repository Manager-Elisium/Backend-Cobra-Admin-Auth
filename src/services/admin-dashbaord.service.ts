...
async function paginationDashboardService(body: any) {
    ...
    const lobbyImageAndTitleStatistics = await axios.get(`http://43.204.102.183:3001/lobby/get-list`, {
        headers: {
    ...
    const vipCardImageAndTitleStatistics = await axios.get(`http://43.204.102.183:3001/vip_card/get-list`, {
        headers: {
            "Content-Type": "application/json"
        }
    });
...
async function vipCardDashboardService(body: any) {
    try {
        ...
        if (isAvailable) {
            ...
            const vipCardStatistics = await axios.get(`http://43.204.102.183:3001/vip_card/get-list`, {
                headers: {
                    "Content-Type": "application/json"
                }
            });
...
async function lobbyDashboardService(body: any) {
    try {
        ...
        if (isAvailable) {
            ...
            const lobbyStatistics = await axios.get(`http://43.204.102.183:3001/lobby/get-list`, {
                headers: {
                    "Content-Type": "application/json"
                }
            });
