...
const admin_user_service_1 = require("src/services/admin-user.service");
...
function insert(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let data = yield (0, admin_user_service_1.createAdminService)(reqBody);
...
function allDataList(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let data = yield (0, admin_user_service_1.paginationAdminService)(query);
            let encryptedData = (0, encrypt_1.encrypt)(JSON.stringify(data), secretKey);
            return res.json({ status: true, data: yield encryptedData, message: "Admin User List" });
        }
        catch (error) {
            return res.json({ status: false, message: (_a = error === null || error === void 0 ? void 0 : error.message) !== null && _a !== void 0 ? _a : "" });
        }
...
function getAdmin(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const { id } = req.params;
            let data = yield (0, admin_user_service_1.findOneAdminService)(id);
            let encryptedData = (0, encrypt_1.encrypt)(JSON.stringify(data), secretKey);
            return res.json({ status: true, data: yield encryptedData, message: "Get Admin successfully" }); // : 
        }
        catch (error) {
            return res.json({ status: false, message: (_a = error === null || error === void 0 ? void 0 : error.message) !== null && _a !== void 0 ? _a : "" });
        }
...
function update(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const { id } = req.params;
            const updateAchievement = yield (0, admin_user_service_1.updateAdminService)(id, req.body);
...
function updatePassword(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const { token } = req.body;
            const updateAchievement = yield (0, admin_user_service_1.updatePasswordAdminService)(token === null || token === void 0 ? void 0 : token.ADMIN_ID, req.body);
            let encryptedData = yield (0, encrypt_1.encrypt)(JSON.stringify(updateAchievement), secretKey);
            return res.json({
                status: true, data: encryptedData, message: "Updated Data Sucessfully"
            });
