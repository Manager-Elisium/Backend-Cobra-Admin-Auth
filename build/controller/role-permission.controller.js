...
const role_permission_service_1 = require("src/services/role-permission.service");
...
function allDataList(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let data = yield (0, role_permission_service_1.paginationRolePermissionService)(query);
...
function updatePermission(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let data = yield (0, role_permission_service_1.updateRolePermissionService)(reqBody);
            let encryptedData = yield (0, encrypt_1.encrypt)(JSON.stringify(data), secretKey);
